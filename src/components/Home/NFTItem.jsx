...
const NFTItem = ({ image, featured, bid, userImage, name, nickname, price, love, newBid, hot, sold, owned }) => <div className="col-12 col-sm-6 col-lg-4 col-xl-3 list-item cards">
  <div className="nft-card card shadow-sm">
    <div className="card-body">
      ...
      {
        owned &&
        <div className="name-author"><a className="name d-block hover-primary fw-bold text-truncate owned-title" href="item-details.html" data-bs-toggle="tooltip" data-bs-placement="top" title={name}>{name}</a></div>
